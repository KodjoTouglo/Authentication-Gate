...
class User(AbstractUser):
    ...
    last_name = models.CharField("Surname", max_length=50, blank=True, null=True)
    is_active = models.BooleanField("active", default=True)
    email = models.EmailField("Email address", blank=True, null=True)
    taxpayer_id = models.CharField("Taxpayer's identification number", max_length=32, blank=True, null=True)
    gender = models.CharField("Gender", choices=GENDER, max_length=12, blank=True, null=True)
    place_of_birth = models.CharField("Place of birth", max_length=74, blank=True, null=True)
    birth_date = models.DateField("Birthdate", blank=True, null=True)
    origin = models.CharField("From which country this user come from", max_length=254, blank=True, null=True)
    ...
    def persistent_id(self, entityid):
        """
        returns persistent id related to a recipient (Service Provider) entity id
        """
